  ...
  render() {
    ...
    return (
      ...
      <nav id="nav-wrap">
         ...
         <a className="mobile-btn" href="#nav-wrap" title="Show navigation">Mostar</a>
         ...
         <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#contact">Conta</a></li>
         </ul>
      ...
      <div className="row banner">
         <div className="banner-text">
            ...
            <h3>Soy de {city} actualmente, <span>{occupation}</span>. {description}.</h3>
            <hr />
            <ul className="social">
               {networks}
            </ul>
